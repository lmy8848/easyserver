...
func (r *sqliteRepo) ListGlobalConfigs(ctx context.Context, category string) ([]GlobalConfig, error) {
	var rows *sql.Rows
	var err error
...
func (r *sqliteRepo) GetGlobalConfig(ctx context.Context, id int64) (*GlobalConfig, error) {
	c := &GlobalConfig{}
	err := r.db.QueryRowContext(ctx,
...
func (r *sqliteRepo) CreateGlobalConfig(ctx context.Context, c *GlobalConfig) error {
	result, err := r.db.ExecContext(ctx,
...
func (r *sqliteRepo) UpdateGlobalConfig(ctx context.Context, c *GlobalConfig) error {
	_, err := r.db.ExecContext(ctx,
...
func (r *sqliteRepo) DeleteGlobalConfig(ctx context.Context, id int64) error {
	_, err := r.db.ExecContext(ctx, "DELETE FROM global_configs WHERE id = ?", id)
	return err
}

func (r *sqliteRepo) CreateGlobalConfigIfNotExists(ctx context.Context, c *GlobalConfig) error {
	var count int
