...
// ProcessRepository implements repository.ProcessRepository for SQLite
...
func (r *ProcessRepository) ListProcesses(ctx context.Context) ([]model.Process, error) {
...
func (r *ProcessRepository) GetProcessByID(ctx context.Context, id int64) (*model.Process, error) {
	var p model.Process
...
func (r *ProcessRepository) CreateProcess(ctx context.Context, p *model.Process) (int64, error) {
...
func (r *ProcessRepository) UpdateProcess(ctx context.Context, id int64, req *model.UpdateProcessRequest) error {
	if req.Name != nil {
...
func (r *ProcessRepository) GetAutoStartIDs(ctx context.Context) ([]int64, error) {
...
func (r *ProcessRepository) UpsertStatus(ctx context.Context, processID int64, status string, pid int, exitCode int, lastError string) error {
...
func (r *ProcessRepository) GetStatus(ctx context.Context, processID int64) (*model.ProcessStatus, error) {
...
func (r *ProcessRepository) IncrementRestarts(ctx context.Context, processID int64) error {
	_, err := r.db.ExecContext(ctx,
...
func (r *ProcessRepository) ClearExitInfo(ctx context.Context, processID int64) error {
	_, err := r.db.ExecContext(ctx,
...
func (r *ProcessRepository) AppendLog(ctx context.Context, processID int64, logType, content string) error {
	_, err := r.db.ExecContext(ctx,
...
func (r *ProcessRepository) ListLogs(ctx context.Context, processID int64, limit, offset int) ([]model.ProcessLog, int, error) {
	var total int
...
func (r *ProcessRepository) ListGroups(ctx context.Context) ([]model.ProcessGroup, error) {
	rows, err := r.db.QueryContext(ctx,
...
func (r *ProcessRepository) GetGroup(ctx context.Context, id int64) (*model.ProcessGroup, error) {
	var g model.ProcessGroup
	err := r.db.QueryRowContext(ctx,
...
func (r *ProcessRepository) CreateGroup(ctx context.Context, name, description string) (int64, error) {
...
func (r *ProcessRepository) UpdateGroup(ctx context.Context, id int64, req *model.UpdateProcessGroupRequest) error {
	if req.Name != nil {
...
func (r *ProcessRepository) DeleteGroup(ctx context.Context, id int64) error {
	tx, err := r.db.BeginTx(ctx, nil)
	if err != nil {
		return err
	}
...
func scanProcess(rows *sql.Rows) (model.Process, error) {
	...
	if err := rows.Scan(
		...
		return model.Process{}, fmt.Errorf("scan process: %w", err)
	}
	p.AutoRestart = autoRestart != 0
	p.AutoStart = autoStart != 0
	return p, nil
