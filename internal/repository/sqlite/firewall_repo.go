...
// FirewallRepository implements repository.FirewallRepository for SQLite
type FirewallRepository struct {
	db *sql.DB
}

// NewFirewallRepository creates a new FirewallRepository
func NewFirewallRepository(db *sql.DB) repository.FirewallRepository {
	return &FirewallRepository{db: db}
}

// CountEnabledRules returns the count of enabled firewall rules
func (r *FirewallRepository) CountEnabledRules(ctx context.Context) (int, error) {
	var count int
...
func (r *FirewallRepository) ListRules(ctx context.Context) ([]model.FirewallRule, error) {
...
func (r *FirewallRepository) GetRule(ctx context.Context, id int64) (*model.FirewallRule, error) {
	var rule model.FirewallRule
	var enabled int
	var port, source, target, ipVersion, remark sql.NullString
...
func (r *FirewallRepository) CreateRule(ctx context.Context, rule *model.FirewallRule) error {
...
func (r *FirewallRepository) UpdateRule(ctx context.Context, rule *model.FirewallRule) error {
...
func (r *FirewallRepository) SwapPriorities(ctx context.Context, id1 int64, priority1 int64, id2 int64, priority2 int64) error {
