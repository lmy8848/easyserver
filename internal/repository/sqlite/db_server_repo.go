...
// DBServerRepository implements repository.DBServerRepository for SQLite
type DBServerRepository struct {
	db *sql.DB
}

// NewDBServerRepository creates a new DBServerRepository
func NewDBServerRepository(db *sql.DB) repository.DBServerRepository {
	return &DBServerRepository{db: db}
}

// ListServers returns all database servers
func (r *DBServerRepository) ListServers(ctx context.Context) ([]model.DBServer, error) {
...
func (r *DBServerRepository) GetServer(ctx context.Context, id int64) (*model.DBServer, error) {
	ds := &model.DBServer{}
...
func (r *DBServerRepository) SeedServer(ctx context.Context, name, displayName, description string, defaultPort int) error {
	var count int
...
func (r *DBServerRepository) ListVersions(ctx context.Context, dbServerID int64) ([]model.DBVersion, error) {
...
func (r *DBServerRepository) GetVersion(ctx context.Context, id int64) (*model.DBVersion, error) {
	v := &model.DBVersion{}
...
func (r *DBServerRepository) CountVersionsByServerAndVersion(ctx context.Context, dbServerID int64, version string) (int, error) {
	var count int
...
func (r *DBServerRepository) CreateVersion(ctx context.Context, dbServerID int64, version, serviceName string, port int, status string) (int64, error) {
...
func (r *DBServerRepository) DeleteVersion(ctx context.Context, id int64) error {
...
func (r *DBServerRepository) CountDatabasesByVersion(ctx context.Context, versionID int64) (int, error) {
	var count int
...
func (r *DBServerRepository) UpdateVersionStatus(ctx context.Context, id int64, status string) error {
...
func (r *DBServerRepository) UpdateVersionPort(ctx context.Context, id int64, port int) error {
...
func (r *DBServerRepository) UpdateServerStatus(ctx context.Context, id int64, status, versionSummary string) error {
