...
func (h *ContainerHandler) DetectDocker(c *gin.Context) {
	status, err := h.dockerService.DetectDocker(c.Request.Context())
	if err != nil {
...
func (h *ContainerHandler) InstallDocker(c *gin.Context) {
	if err := h.dockerService.InstallDocker(c.Request.Context()); err != nil {
		InternalError(c, err.Error())
		return
	}
...
func (h *ContainerHandler) StartDocker(c *gin.Context) {
	if err := h.dockerService.StartDocker(c.Request.Context()); err != nil {
		InternalError(c, err.Error())
		return
	}
...
func (h *ContainerHandler) StopDocker(c *gin.Context) {
	if err := h.dockerService.StopDocker(c.Request.Context()); err != nil {
		InternalError(c, err.Error())
		return
	}
...
func (h *ContainerHandler) RestartDocker(c *gin.Context) {
	if err := h.dockerService.RestartDocker(c.Request.Context()); err != nil {
		InternalError(c, err.Error())
		return
	}
...
func (h *ContainerHandler) ConfigureMirror(c *gin.Context) {
	...
	if err := h.dockerService.ConfigureMirror(c.Request.Context(), req.MirrorURL); err != nil {
		InternalError(c, err.Error())
		return
	}
...
func (h *ContainerHandler) GetContainerLogs(c *gin.Context) {
	id := c.Param("id")
	tail := service.DefaultLogTail
	if t, err := strconv.Atoi(c.Query("tail")); err == nil && t > 0 {
		if t > service.MaxLogTail {
			t = service.MaxLogTail
		}
		tail = t
	}
...
func (h *ContainerHandler) ListComposeProjects(c *gin.Context) {
	projects, err := h.composeService.ListProjects(c.Request.Context())
	if err != nil {
		InternalError(c, err.Error())
		return
	}
...
func (h *ContainerHandler) ComposeUp(c *gin.Context) {
	...
	if err := h.composeService.Up(c.Request.Context(), req.ProjectDir); err != nil {
		InternalError(c, err.Error())
		return
	}
...
func (h *ContainerHandler) ComposeDown(c *gin.Context) {
	...
	if err := h.composeService.Down(c.Request.Context(), req.ProjectDir); err != nil {
		InternalError(c, err.Error())
		return
	}
...
func (h *ContainerHandler) ComposeRestart(c *gin.Context) {
	...
	if err := h.composeService.Restart(c.Request.Context(), req.ProjectDir); err != nil {
		InternalError(c, err.Error())
		return
	}
...
func (h *ContainerHandler) ComposeLogs(c *gin.Context) {
	...
	logs, err := h.composeService.GetLogs(c.Request.Context(), projectDir, tail)
	if err != nil {
		InternalError(c, err.Error())
		return
	}
...
func (h *ContainerHandler) ComposeGetConfig(c *gin.Context) {
	projectDir := c.Query("dir")
	content, err := h.composeService.GetConfig(c.Request.Context(), projectDir)
	if err != nil {
		InternalError(c, err.Error())
		return
	}
...
func (h *ContainerHandler) ComposeSaveConfig(c *gin.Context) {
	...
	if err := h.composeService.SaveConfig(c.Request.Context(), req.ProjectDir, req.Content); err != nil {
		InternalError(c, err.Error())
		return
	}
...
func (h *ContainerHandler) CreateVolume(c *gin.Context) {
	...
	if err := h.volumeService.CreateVolume(c.Request.Context(), req.Name, req.Driver); err != nil {
		InternalError(c, err.Error())
		return
	}
...
func (h *ContainerHandler) RemoveVolume(c *gin.Context) {
	name := c.Param("name")
	force := c.Query("force") == "true"
	if err := h.volumeService.RemoveVolume(c.Request.Context(), name, force); err != nil {
		InternalError(c, err.Error())
		return
	}
...
func (h *ContainerHandler) CreateNetwork(c *gin.Context) {
	...
	if err := h.networkService.CreateNetwork(c.Request.Context(), req.Name, req.Driver); err != nil {
		InternalError(c, err.Error())
		return
	}
